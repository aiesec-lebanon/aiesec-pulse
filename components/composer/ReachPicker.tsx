      ...
      {networkChosen && (
        <div className="mt-3">
          ...
          <input
            ...
            className="min-h-[44px] w-full rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--card)] px-3 py-2 text-[15px] text-[color:var(--foreground)] focus:border-[var(--primary)] focus:outline-none disabled:opacity-50"
          />
          {error && (
            <p
